...
for perm in range(10000):
    ...
    hcp_g_shuff = shuffle(hcp_g, random_state=random_state_perm)
...
np.save('hcp_bbs_test_r2_z_arr.npy', bbs_test_r2_z_arr)
np.save('hcp_bbs_test_mse_z_arr.npy', bbs_test_mse_z_arr)
np.save('hcp_bbs_test_r2_z_shuff_arr.npy', bbs_test_r2_z_shuff_arr)
np.save('hcp_bbs_test_mse_z_shuff_arr.npy', bbs_test_mse_z_shuff_arr)
np.save('hcp_bbs_test_r2_ct_arr.npy', bbs_test_r2_ct_arr)
np.save('hcp_bbs_test_mse_ct_arr.npy', bbs_test_mse_ct_arr)
np.save('hcp_bbs_test_r2_ct_shuff_arr.npy', bbs_test_r2_ct_shuff_arr)
np.save('hcp_bbs_test_mse_ct_shuff_arr.npy', bbs_test_mse_ct_shuff_arr)
...
np.save('hcp_bbs_r2_diff_perm.npy',bbs_r2_perm_arr)
np.save('hcp_bbs_mse_diff_perm.npy',bbs_mse_perm_arr)
np.save('hcp_bbs_r2_diff_perm_shuff.npy',bbs_r2_perm_shuff_arr)
np.save('hcp_bbs_mse_diff_perm_shuff.npy',bbs_mse_perm_shuff_arr)
...
np.save('hcp_cpm_test_mse_z_arr.npy', cpm_test_mse_z_arr)
np.save('hcp_cpm_test_mse_ct_arr.npy', cpm_test_mse_ct_arr)
np.save('hcp_cpm_test_mse_z_shuff_arr.npy', cpm_test_mse_z_shuff)
np.save('hcp_cpm_test_mse_ct_shuff_arr.npy', cpm_test_mse_ct_shuff_arr)

cpm_perm_arr = np.array(cpm_perm)
cpm_perm_shuff_arr = np.array(cpm_perm_shuff)
np.save('hcp_cpm_perm.npy',cpm_perm_arr)
np.save('hcp_cpm_perm_shuff.npy',cpm_perm_shuff_arr)
...
np.save('hcp_lasso_test_mse_z_arr.npy', lasso_test_mse_z_arr)
np.save('hcp_lasso_test_mse_ct_arr.npy', lasso_test_mse_ct_arr)
np.save('hcp_lasso_test_mse_z_shuff_arr.npy', lasso_test_mse_z_shuff_arr)
np.save('hcp_lasso_test_mse_ct_shuff_arr.npy', lasso_test_mse_ct_shuff_ar)

lasso_perm_arr = np.array(lasso_perm)
lasso_perm_shuff_arr = np.array(lasso_perm_shuff)
np.save('hcp_lasso_perm.npy',lasso_perm_arr)
np.save('hcp_lasso_perm_shuff.npy',lasso_perm_shuff_arr)
...
np.save('hcp_ridge_test_mse_z_arr.npy', ridge_test_mse_z_arr)
np.save('hcp_ridge_test_mse_ct_arr.npy', ridge_test_mse_ct_arr)
np.save('hcp_ridge_test_mse_z_shuff_arr.npy', ridge_test_mse_z_shuff_arr)
np.save('hcp_ridge_test_mse_ct_shuff_arr.npy', ridge_test_mse_ct_shuff_arr)

ridge_perm_arr = np.array(ridge_perm)
ridge_perm_shuff_arr = np.array(ridge_perm_shuff)
np.save('hcp_ridge_perm.npy',ridge_perm_arr)
np.save('hcp_ridge_perm_shuff.npy',ridge_perm_shuff)
...
np.save('hcp_enet_test_mse_z_arr.npy', enet_test_mse_z_arr)
np.save('hcp_enet_test_mse_ct_arr.npy', enet_test_mse_ct_arr)
np.save('hcp_enet_test_mse_z_shuff_arr.npy', enet_test_mse_z_shuff_arr)
np.save('hcp_enet_test_mse_ct_shuff_arr.npy', enet_test_mse_ct_shuff_arr)

enet_perm_arr = np.array(enet_perm)
enet_perm_shuff_arr = np.array(enet_perm_shuff)
np.save('hcp_enet_perm.npy',enet_perm_arr)
np.save('hcp_enet_perm_shuff.npy',enet_perm_shuff_arr)