...
hcp_yeo_z = np.load('hcp_yeo_z.npy')
hcp_yeo_resid = np.load('hcp_yeo_resid.npy')
hcp_yeo_g = np.load('hcp_yeo_g.npy')
...
train_data_ct = hcp_yeo_resid[train_idxs, :]
test_data_ct = hcp_yeo_resid[test_idxs, :]
...
for perm in range(10000):
    ...
    hcp_g_shuff = shuffle(hcp_yeo_g, random_state=random_state_perm)
...
np.save('hcp_yeo_bbs_test_r2_z_arr.npy', bbs_test_r2_z_arr)
np.save('hcp_yeo_bbs_test_mse_z_arr.npy', bbs_test_mse_z_arr)
np.save('hcp_yeo_bbs_test_r2_z_shuff_arr.npy', bbs_test_r2_z_shuff_arr)
np.save('hcp_yeo_bbs_test_mse_z_shuff_arr.npy', bbs_test_mse_z_shuff_arr)
np.save('hcp_yeo_bbs_test_r2_ct_arr.npy', bbs_test_r2_ct_arr)
np.save('hcp_yeo_bbs_test_mse_ct_arr.npy', bbs_test_mse_ct_arr)
np.save('hcp_yeo_bbs_test_r2_ct_shuff_arr.npy', bbs_test_r2_ct_shuff_arr)
...
np.save('hcp_yeo_bbs_r2_diff_perm.npy',bbs_r2_perm_arr)
np.save('hcp_yeo_bbs_mse_diff_perm.npy',bbs_mse_perm_arr)
np.save('hcp_yeo_bbs_r2_diff_perm_shuff.npy',bbs_r2_perm_shuff_arr)
np.save('hcp_yeo_bbs_mse_diff_perm_shuff.npy',bbs_mse_perm_shuff_arr)